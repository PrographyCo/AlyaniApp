									...
									<form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<textarea name="name_ar" required class="form-control"><? echo $_POST['name_ar'] ?: $row['name_ar']?></textarea>
											</div>
											<div class="form-group col-sm-4">
												<label><?=LBL_TitleEn;?></label>
												<textarea name="name_en" required class="form-control"><? echo $_POST['name_en'] ?: $row['name_en']?></textarea>
											</div>
											<div class="form-group col-sm-4">
												<label><?=LBL_TitleUr;?></label>
												<textarea name="name_ur" required class="form-control"><? echo $_POST['name_ur'] ?: $row['name_ur']?></textarea>
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_about;?> AR</label>
												<textarea name="about_ar" class="form-control" required ><? echo $_POST['about_ar'] ?: $row['about_ar']?></textarea>
											</div>
                                                <div class="form-group col-sm-4">
												<label><?=LBL_about;?> EN</label>
												<textarea name="about_en" class="form-control" required ><? echo $_POST['about_en'] ?: $row['about_en']?></textarea>
											</div>
								        	<div class="form-group col-sm-4">
							        				<label><?=LBL_about;?> UR</label>
												<textarea name="about_ur" class="form-control" required ><? echo $_POST['about_ur'] ?: $row['about_ur']?></textarea>
											</div>
