      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <button onclick="convertpdf()" class="btn btn-success pull-<?=DIR_AFTER;?>" style="margin-<?=DIR_AFTER;?>: 10px" target="_blank"><i class="fa fa-file-pdf-o"></i> <?=BTN_ExportToPDF;?></button>
