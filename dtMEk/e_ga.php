                ...
                <div class="box-body">
									<form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<select name="ga_type" class="form-control" onchange="typechanged(this.value); return false;">
												<option value="1" <? if ($row['ga_type'] == 1) echo 'selected="selected"';?>><?=LBL_Text;?></option>
												<option value="2" <? if ($row['ga_type'] == 2) echo 'selected="selected"';?>><?=LBL_PDFFILE;?></option>
											</select>
										</div>
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<input type="text" class="form-control" name="ga_title_ar" required="required" value="<? echo $_POST['ga_title_ar'] ?: $row['ga_title_ar']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleEn;?></label>
												<input type="text" class="form-control" name="ga_title_en" required="required" value="<? echo $_POST['ga_title_en'] ?: $row['ga_title_en']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleUr;?></label>
												<input type="text" class="form-control" name="ga_title_ur" required="required" value="<? echo $_POST['ga_title_ur'] ?: $row['ga_title_ur']?>" />
											</div>

										</div>

										<div id="div_text" style="<? if ($row['ga_type'] == 1 || $_POST['ga_type'] == 1 || !$row) echo 'display:block'; else echo 'display:none'; ?>">

											<div class="row">

												<div class="form-group col-sm-4">
													<label><?=LBL_DescrAr;?></label>
													<textarea name="ga_body_ar" class="form-control"><? echo $_POST['ga_body_ar'] ?: $row['ga_body_ar']?></textarea>
												</div>

												<div class="form-group col-sm-4">
													<label><?=LBL_DescrEn;?></label>
													<textarea name="ga_body_en" class="form-control"><? echo $_POST['ga_body_en'] ?: $row['ga_body_en']?></textarea>
												</div>

												<div class="form-group col-sm-4">
													<label><?=LBL_DescrUr;?></label>
													<textarea name="ga_body_ur" class="form-control"><? echo $_POST['ga_body_ur'] ?: $row['ga_body_ur']?></textarea>
												</div>
										...
										<div id="div_file" style="<? if ($row['ga_type'] == 2 || $_POST['ga_type'] == 2) echo 'display:block'; else echo 'display:none'; ?>">
	                        ...
	                        ?>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="ga_order" value="<? echo $_POST['ga_order'] ?: $row['ga_order']?>" />
										</div>

										<div class="form-group">
											<label><input type="checkbox" name="ga_active" <? if (!$row || $row['ga_active'] == 1) echo 'checked="checked"';?> /> <?=LBL_Active;?></label>
										</div>
