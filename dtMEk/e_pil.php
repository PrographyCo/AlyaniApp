              ...
              <div class="box box-info">
                ...
                <div class="box-body">
									...
									<div class="row">
										...
										<div class="form-group col-sm-6">
											...
											<input type="text" class="form-control" name="pil_name" required="required" value="<? echo $_POST['pil_name'] ?: $row['pil_name']?>" />
										</div>
									...
									<div class="row">
										...
										<div class="form-group col-sm-6">
											...
											<select name="pil_gender" id="pil_gender" class="form-control select2">
												<option value="m" <? if ($row['pil_gender'] == 'm') echo 'selected="selected"';?>><?=LBL_Male;?></option>
												<option value="f" <? if ($row['pil_gender'] == 'f') echo 'selected="selected"';?>><?=LBL_Female;?></option>
											</select>
										</div>
									</div>
									<div class="row">
										<div class="form-group col-sm-6">
											...
											<input type="text" class="form-control" name="pil_phone" required="required" value="<? echo $_POST['pil_phone'] ?: $row['pil_phone']?>" />
										</div>

										<div class="form-group col-sm-6">
											<label><?=LBL_NationalId;?></label>
											<input type="text" class="form-control" name="pil_nationalid" required="required" value="<? echo $_POST['pil_nationalid'] ?: $row['pil_nationalid']?>" />
										</div>
									</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="pil_reservation_number" required="required" value="<? echo $_POST['pil_reservation_number'] ?: $row['pil_reservation_number']?>" />
										</div>

										<div class="form-group">
											<label><?=LBL_City;?></label>
											<select name="pil_city_id" class="form-control select2" onchange="cityselected(this.value)" required="required">
										...
										<div class="row">
											...
											<div class="form-group col-sm-6">
												...
												<? if ($row['pil_photo']) echo '<img src="media/pils/'.$row['pil_photo'].'" width="150"/>'; ?>
										...
										<div class="form-group">
											<label><input type="checkbox" name="pil_active" <? if (!$row || $row['pil_active'] == 1) echo 'checked="checked"';?> /> <?=LBL_Active;?></label>
										</div>
                ...
                <div class="box-body">
									...
									<?
										...
										if ($accomoinfo) {
											...
											if ($accomoinfo['halls_id'] != 0) {
												...
												echo '</div>';
												echo '<div class="col-sm-6">';
												echo '<b>'.with_seat.'</b><br />'?><? if($accomoinfo['seats'] == 1){echo with_seat;} else {echo without_seat;}
												echo '</div>';
												echo '</div>';
												echo '</div>';
									...
									<div class="form-group">
										...
										<select name="pil_accomo_type" class="form-control select2" onchange="pilaccomoselect(this.value);">
