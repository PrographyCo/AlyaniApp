									...
									<form method="post" action="auto_accomo_buses.php" enctype="multipart/form-data">
										...
										<div class="row">
											<div class="form-group col-sm-4">
												...
												<select name="city_id[]" id="city_id[]" class="form-control select2" multiple="multiple" onchange="cities_selected(); countCitiesPilsBuses(); calcAvailAccomo();">
													<?
											...
											<div class="form-group col-sm-4">
												...
												<select name="gender" id="gender" class="form-control select2" onchange="countCitiesPilsBuses(); calcAvailAccomo();">
													<option value="0">
														<?=LBL_All;?>
													</option>
											...
											<div class="form-group col-sm-4">
												...
												<select name="pilc_id" id="pilc_id" class="form-control select2" onchange="countCitiesPilsBuses();">
													<option value="0">
														<?=LBL_All;?>
													</option>
													<?
