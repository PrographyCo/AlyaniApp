								...
								<div class="box-body">
									<form method="post" action="auto_accomo_arafa.php" enctype="multipart/form-data">
										...
										<div class="panel well">
											<?=LBL_NotAccomoPilgrims;?>: <span id="countpils"></span> - <?=LBL_AvailableForAccomo;?>: <span id="availcount">0</span>
										</div>
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<div id="TentsArea">
													<select name="hallsarfa_id[]" id="halls_arfa[]" class="form-control select2" multiple="multiple" onchange="calcAvailAccomo();">
														<?
