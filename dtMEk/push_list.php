      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <a href="push_new.php" class="btn btn-success pull-<?=DIR_AFTER;?>"><i class="fa fa-star"></i> <?=LBL_SendNewNotification;?></a>
          </h1>
        </section>
                  ...
                  <table class="datatable-table4 table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <td>'.date("j F Y g:i:s a", $row['msg_date']).'</td>';
                                    echo '<td>';
													echo '
									<a href="'.basename($_SERVER['PHP_SELF']).'?del='.$row['msg_id'].'" class="label label-danger" onclick="return confirm(\''.LBL_DeleteConfirm.'\');"><i class="fa fa-trash"></i> '.LBL_Delete.'</a>';
	                        echo '</td>';
                        echo '
                      </tr>';
