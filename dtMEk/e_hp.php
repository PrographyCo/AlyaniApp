									...
									<form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<input type="text" class="form-control" name="hp_title_ar" required="required" value="<? echo $_POST['hp_title_ar'] ?: $row['hp_title_ar']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleEn;?></label>
												<input type="text" class="form-control" name="hp_title_en" required="required" value="<? echo $_POST['hp_title_en'] ?: $row['hp_title_en']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleUr;?></label>
												<input type="text" class="form-control" name="hp_title_ur" required="required" value="<? echo $_POST['hp_title_ur'] ?: $row['hp_title_ur']?>" />
											</div>
										...
										<div class="form-group">
											...
											<? if ($row['hp_photo']) echo '<img src="media/hajalbum/'.$row['hp_photo'].'" width="150"/>'; ?>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="hp_order" value="<? echo $_POST['hp_order'] ?: $row['hp_order']?>" />
										</div>

										<div class="form-group">
											<label><input type="checkbox" name="hp_active" <? if (!$row || $row['hp_active'] == 1) echo 'checked="checked"';?> /> <?=LBL_Active;?></label>
										</div>
										...
										<input type="hidden" name="hp_dateadded" id="hp_dateadded" value="<?=$row['hp_dateadded'];?>" />
									</form>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!--/.col (left) -->
