                ...
                <div class="box-body">
	                ...
	                <form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="ws_facebook" value="<? echo $_POST['ws_facebook'] ?: $ws_facebook;?>" />
										</div>

										<div class="form-group">
											<label><?=LBL_Twitter;?></label>
											<input type="text" class="form-control" name="ws_twitter" value="<? echo $_POST['ws_twitter'] ?: $ws_twitter;?>" />
										</div>

										<div class="form-group">
											<label><?=LBL_Whatsapp;?></label>
											<input type="text" class="form-control" name="ws_whatsapp" value="<? echo $_POST['ws_whatsapp'] ?: $ws_whatsapp;?>" />
										</div>

										<div class="form-group">
											<label><?=LBL_Snapchat;?></label>
											<input type="text" class="form-control" name="ws_snapchat" value="<? echo $_POST['ws_snapchat'] ?: $ws_snapchat;?>" />
										</div>

										<div class="form-group">
											<label><?=LBL_Instagram;?></label>
											<input type="text" class="form-control" name="ws_instagram" value="<? echo $_POST['ws_instagram'] ?: $ws_instagram;?>" />
										</div>
