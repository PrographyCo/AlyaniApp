                                ...
                                while ($row = $sql->fetch()) {
                                    ...
                                    if ($sql2->rowCount() > 0) {
                                        ...
                                        while ($row2 = $sql2->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            echo '<span class="label label-default">' . $row2['staff_name'] . '</span> ';
                                    ...
                                    echo '</td>';
                                    echo '<td>';
                                    if ($row['city_active'] == 1) echo '<span class="label label-success">' . LBL_Active . '</span>';
