                  ...
                  <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <select name="au_type" class="form-control select2" onchange="typechanged(this.value)">
                        <option value="1" <? if ($auinfo['au_type'] == 1) echo 'selected="selected"';?>><?=LBL_Text;?></option>
                        <option value="2" <? if ($auinfo['au_type'] == 2) echo 'selected="selected"';?>><?=LBL_Video;?></option>
                        <option value="3" <? if ($auinfo['au_type'] == 3) echo 'selected="selected"';?>><?=LBL_YTVideo;?></option>
                      </select>
                    ...
                    <div id="div_text" style="<? if ($auinfo['au_type'] == 1) echo 'display:block'; else echo 'display:none'; ?>">
                      <div class="form-group">
                        <label><?=LBL_DescrAr;?></label>
                        <textarea name="au_body_ar" class="form-control"><?=$auinfo['au_body_ar'];?></textarea>
                      </div>

                      <div class="form-group">
                        <label><?=LBL_DescrEn;?></label>
                        <textarea name="au_body_en" class="form-control"><?=$auinfo['au_body_en'];?></textarea>
                      </div>

                      <div class="form-group">
                        <label><?=LBL_DescrUr;?></label>
                        <textarea name="au_body_ur" class="form-control"><?=$auinfo['au_body_ur'];?></textarea>
                      </div>

                    </div>

                    <div id="div_video" style="<? if ($auinfo['au_type'] == 2) echo 'display:block'; else echo 'display:none'; ?>">
                      <div class="form-group">
                    ...
                    <div id="div_ytvideo" style="<? if ($auinfo['au_type'] == 3) echo 'display:block'; else echo 'display:none'; ?>">
                      <div class="form-group">
                        <label><?=LBL_YTVideoID;?></label>
                        <input type="text" name="au_youtube_id" id="au_youtube_id" class="form-control" value="<?=$auinfo['au_youtube_id'];?>" />
                        <? if ($auinfo['au_youtube_id']) {
                    ...
                    <input type="submit" class="col-md-12 btn btn-success" value="<? echo LBL_Update; ?>" />
