                    ...
                    <div class="box-body">
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <textarea name="promo_body_ar"
                                              class="form-control"><?php echo $_POST['promo_body_ar'] ?: $row['promo_body_ar'] ?></textarea>
                                </div>

                                <div class="form-group col-sm-4">
                                    <label><?= LBL_DescrEn; ?></label>
                                    <textarea name="promo_body_en"
                                              class="form-control"><?php echo $_POST['promo_body_en'] ?: $row['promo_body_en'] ?></textarea>
                                </div>

                                <div class="form-group col-sm-4">
                                    <label><?= LBL_DescrUr; ?></label>
                                    <textarea name="promo_body_ur"
                                              class="form-control"><?php echo $_POST['promo_body_ur'] ?: $row['promo_body_ur'] ?></textarea>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php if ($row['promo_photo']) echo '<img src="media/promos/' . $row['promo_photo'] . '" width="150"/>'; ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="promo_order"
                                       value="<?php echo $_POST['promo_order'] ?: $row['promo_order'] ?>"/>
                            </div>

                            <div class="form-group">
                                <label><input type="checkbox"
                                              name="promo_active" <?php if (!$row || $row['promo_active'] == 1) echo 'checked="checked"'; ?> /> <?= LBL_Active; ?>
                                </label>
                            </div>
