                        ...
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="floor_title" required="required"
                                       value="<?php echo $_POST['floor_title'] ?: $row['floor_title'] ?>"/>
                            </div>

                            <div class="form-group">
                                <label><?= LBL_Order; ?></label>
                                <input type="text" class="form-control" name="floor_order"
                                       value="<?php echo $_POST['floor_order'] ?: $row['floor_order'] ?>"/>
                            </div>

                            <div class="form-group">
                                <label><input type="checkbox"
                                              name="floor_active" <?php if (!$row || $row['floor_active'] == 1) echo 'checked="checked"'; ?> /> <?= LBL_Active; ?>
                                </label>
                            </div>
