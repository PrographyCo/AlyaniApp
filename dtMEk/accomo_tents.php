      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <a href="export_accomo_tents.php?tent_id=<?=$_GET['tent_id'];?>" class="btn btn-success pull-<?=DIR_AFTER;?>" style="margin-<?=DIR_AFTER;?>: 10px" target="_blank"><i class="fa fa-file-pdf-o"></i> <?=BTN_ExportToPDF;?></a>
            <a href="?remove=1&tent_id=<?=$_GET['tent_id'];?>" onclick="return confirm('<?=LBL_RemoveConfirm;?>');" class="btn btn-danger pull-<?=DIR_AFTER;?>" style="margin-<?=DIR_AFTER;?>: 10px"><i class="fa fa-trash"></i> <?=BTN_REMOVEACCOMO2;?></a>
