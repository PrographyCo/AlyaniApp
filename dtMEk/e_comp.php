...
<script type="text/javascript">
    ...
    function initialize() {
        ...
        <?php if ($row['comp_lat'] && $row['comp_lng']) { ?>
        var mapOptions = {
                    ...
                    <div class="box-body">
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input class="form-control" id="field_lat" name="field_lat" type="text"
                                           value="<?php echo $row['comp_lat'] ?: $_POST['field_lat']; ?>"
                                           placeholder="Latitude"/>
                                    <input class="form-control" id="field_lon" name="field_lon" type="text"
                                           value="<?php echo $row['comp_lng'] ?: $_POST['field_lon']; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <?php if ($row['comp_photo']) echo '<img src="media/ourcompanies/' . $row['comp_photo'] . '" width="150"/>'; ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="comp_phone"
                                       value="<?php echo $_POST['comp_phone'] ?: $row['comp_phone'] ?>"/>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="comp_fb"
                                           value="<?php echo $_POST['comp_fb'] ?: $row['comp_fb'] ?>"/>
                                </div>

                                <div class="form-group col-sm-6">
                                    <label><?= LBL_Twitter; ?></label>
                                    <input type="text" class="form-control" name="comp_twitter"
                                           value="<?php echo $_POST['comp_twitter'] ?: $row['comp_twitter'] ?>"/>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="comp_order"
                                       value="<?php echo $_POST['comp_order'] ?: $row['comp_order'] ?>"/>
                            </div>

                            <div class="form-group">
                                <label><input type="checkbox"
                                              name="comp_active" <?php if (!$row || $row['comp_active'] == 1) echo 'checked="checked"'; ?> /> <?= LBL_Active; ?>
                                </label>
                            </div>
