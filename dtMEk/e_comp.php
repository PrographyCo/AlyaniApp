...
if ($_POST) {
	...
	$sql->bindValue("comp_active", ($_POST['comp_active'] ? 1 : 0));
	...
	if ($sql->execute()) {
		...
		if ($_FILES['comp_uphoto']['tmp_name']) {
			...
			if (copy($_FILES['comp_uphoto']['tmp_name'], 'media/ourcompanies/'.$id.'.'.$ext)) {
...
<script type="text/javascript" src="//maps.googleapis.com/maps/api/js?key=AIzaSyDFLHZP4EPU6YhCign3pe3RJ944VNZ08YA&libraries=places&callback=initialize"></script>
                ...
                <div class="box-body">
									<form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											<div class="controls">
												<button class="btn btn-primary" onclick="getcurrentloc(); return false;"><?=LBL_GetCurrentLocation;?></button>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="controls">
												<input class="form-control" id="field_lat" name="field_lat" type="text" value="<? echo $row['comp_lat'] ?: $_POST['field_lat'];?>" placeholder="Latitude" />
												<input class="form-control" id="field_lon" name="field_lon" type="text" value="<? echo $row['comp_lng'] ?: $_POST['field_lon'];?>" placeholder="Longitude" />
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<input type="text" class="form-control" name="comp_title_ar" required="required" value="<? echo $_POST['comp_title_ar'] ?: $row['comp_title_ar']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleEn;?></label>
												<input type="text" class="form-control" name="comp_title_en" required="required" value="<? echo $_POST['comp_title_en'] ?: $row['comp_title_en']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleUr;?></label>
												<input type="text" class="form-control" name="comp_title_ur" required="required" value="<? echo $_POST['comp_title_ur'] ?: $row['comp_title_ur']?>" />
											</div>
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<input type="text" class="form-control" name="comp_addr_ar" required="required" value="<? echo $_POST['comp_addr_ar'] ?: $row['comp_addr_ar']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_AddrEn;?></label>
												<input type="text" class="form-control" name="comp_addr_en" required="required" value="<? echo $_POST['comp_addr_en'] ?: $row['comp_addr_en']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_AddrUr;?></label>
												<input type="text" class="form-control" name="comp_addr_ur" required="required" value="<? echo $_POST['comp_addr_ur'] ?: $row['comp_addr_ur']?>" />
											</div>
										...
										<div class="form-group">
											...
											<? if ($row['comp_photo']) echo '<img src="media/ourcompanies/'.$row['comp_photo'].'" width="150"/>'; ?>
											<input id="comp_uphoto" name="comp_uphoto" type="file" class="file">
										</div>

										<div class="form-group">
											<label><?=LBL_PhoneNumber;?></label>
											<input type="text" class="form-control" name="comp_phone" value="<? echo $_POST['comp_phone'] ?: $row['comp_phone']?>" />
										</div>
										...
										<div class="row">
											...
											<div class="form-group col-sm-6">
												...
												<input type="text" class="form-control" name="comp_fb" value="<? echo $_POST['comp_fb'] ?: $row['comp_fb']?>" />
											</div>

											<div class="form-group col-sm-6">
												<label><?=LBL_Twitter;?></label>
												<input type="text" class="form-control" name="comp_twitter" value="<? echo $_POST['comp_twitter'] ?: $row['comp_twitter']?>" />
											</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="comp_order" value="<? echo $_POST['comp_order'] ?: $row['comp_order']?>" />
										</div>

										<div class="form-group">
											<label><input type="checkbox" name="comp_active" <? if (!$row || $row['comp_active'] == 1) echo 'checked="checked"';?> /> <?=LBL_Active;?></label>
										</div>
										...
										<input type="hidden" name="comp_dateadded" id="comp_dateadded" value="<?=$row['comp_dateadded'];?>" />
									</form>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!--/.col (left) -->
