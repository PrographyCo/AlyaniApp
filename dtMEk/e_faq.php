...
if ($_POST) {
	...
	$sql->bindValue("faq_active", ($_POST['faq_active'] ? 1 : 0));
									...
									<form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<input type="text" class="form-control" name="faq_title_ar" required="required" value="<? echo $_POST['faq_title_ar'] ?: $row['faq_title_ar']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleEn;?></label>
												<input type="text" class="form-control" name="faq_title_en" required="required" value="<? echo $_POST['faq_title_en'] ?: $row['faq_title_en']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleUr;?></label>
												<input type="text" class="form-control" name="faq_title_ur" required="required" value="<? echo $_POST['faq_title_ur'] ?: $row['faq_title_ur']?>" />
											</div>
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<textarea name="faq_answer_ar" class="form-control"><? echo $_POST['faq_answer_ar'] ?: $row['faq_answer_ar']?></textarea>
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_AnswerEn;?></label>
												<textarea name="faq_answer_en" class="form-control"><? echo $_POST['faq_answer_en'] ?: $row['faq_answer_en']?></textarea>
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_AnswerUr;?></label>
												<textarea name="faq_answer_ur" class="form-control"><? echo $_POST['faq_answer_ur'] ?: $row['faq_answer_ur']?></textarea>
											</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="faq_order" value="<? echo $_POST['faq_order'] ?: $row['faq_order']?>" />
										</div>

										<div class="form-group">
											<label><input type="checkbox" name="faq_active" <? if (!$row || $row['faq_active'] == 1) echo 'checked="checked"';?> /> <?=LBL_Active;?></label>
										</div>

										<input type="submit" class="col-md-12 btn btn-success" value="<? echo $edit ? LBL_Update : LBL_Add; ?>" />
										<input type="hidden" name="id" id="id" value="<?=$_GET['id'];?>" />
										<input type="hidden" name="faq_dateadded" id="faq_dateadded" value="<?=$row['faq_dateadded'];?>" />
									</form>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!--/.col (left) -->
