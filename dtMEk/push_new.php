                        ...
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="sound" id="sound" class="form-control select2">
                                    <option value="default" <?php if ($_POST['sound'] == 0) echo 'selected="selected"'; ?>><?= LBL_Default; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="platform" id="platform" class="form-control select2">
                                    <option value="0" <?php if ($_POST['platform'] == 0) echo 'selected="selected"'; ?>><?= LBL_Both; ?></option>
                                    <option value="1" <?php if ($_POST['platform'] == 1) echo 'selected="selected"'; ?>><?= LBL_iPhone; ?></option>
                                    <option value="2" <?php if ($_POST['platform'] == 2) echo 'selected="selected"'; ?>><?= LBL_Android; ?></option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" id="type" class="form-control select2"
                                    ...
                                    <option value="0" <?php if ($_POST['type'] == 0) echo 'selected="selected"'; ?>><?= LBL_All; ?></option>
                                    <option value="1" <?php if ($_POST['type'] == 1) echo 'selected="selected"'; ?>><?= LBL_AllPilgrims; ?></option>
                                    <option value="2" <?php if ($_POST['type'] == 2) echo 'selected="selected"'; ?>><?= LBL_SPECIFICPIL; ?></option>
                                    <option value="3" <?php if ($_POST['type'] == 3) echo 'selected="selected"'; ?>><?= LBL_AllManagers; ?></option>
                                    <option value="4" <?php if ($_POST['type'] == 4) echo 'selected="selected"'; ?>><?= LBL_SPECIFICMANAGER; ?></option>
                                    <option value="5" <?php if ($_POST['type'] == 5) echo 'selected="selected"'; ?>><?= LBL_AllSupervisors; ?></option>
                                    <option value="6" <?php if ($_POST['type'] == 6) echo 'selected="selected"'; ?>><?= LBL_SPECIFICSUPERVISOR; ?></option>
                                </select>
                            </div>
