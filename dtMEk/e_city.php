									...
									<form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<input type="text" class="form-control" name="city_title_ar" required="required" value="<? echo $_POST['city_title_ar'] ?: $row['city_title_ar']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleEn;?></label>
												<input type="text" class="form-control" name="city_title_en" required="required" value="<? echo $_POST['city_title_en'] ?: $row['city_title_en']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleUr;?></label>
												<input type="text" class="form-control" name="city_title_ur" required="required" value="<? echo $_POST['city_title_ur'] ?: $row['city_title_ur']?>" />
											</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="city_prefix" require="required" value="<? echo $_POST['city_prefix'] ?: $row['city_prefix']?>" />
										</div>

										<div class="form-group">
											<label><?=LBL_Order;?></label>
											<input type="text" class="form-control" name="city_order" value="<? echo $_POST['city_order'] ?: $row['city_order']?>" />
										</div>
										...
										<div class="form-group">
											<label><input type="checkbox" name="city_active" <? if (!$row || $row['city_active'] == 1) echo 'checked="checked"';?> /> <?=LBL_Active;?></label>
										</div>
