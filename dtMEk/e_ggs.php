                ...
                <div class="box-body">
									<form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="ggs_name" required="required" value="<? echo $_POST['ggs_name'] ?: $row['ggs_name']?>" />
										</div>
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<input type="text" class="form-control" name="ggs_job_ar" value="<? echo $_POST['ggs_job_ar'] ?: $row['ggs_job_ar']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_JobTitle;?></label>
												<input type="text" class="form-control" name="ggs_job_en" value="<? echo $_POST['ggs_job_en'] ?: $row['ggs_job_en']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_JobTitle;?></label>
												<input type="text" class="form-control" name="ggs_job_ur" value="<? echo $_POST['ggs_job_ur'] ?: $row['ggs_job_ur']?>" />
											</div>
										...
										<div class="form-group">
											...
											<input type="email" class="form-control" name="ggs_email" value="<? echo $_POST['ggs_email'] ?: $row['ggs_email']?>" />
										</div>

										<div class="form-group">
											<label><?=LBL_ContactNumbers;?></label>
											<input type="text" class="form-control" name="ggs_phones" value="<? echo $_POST['ggs_phones'] ?: $row['ggs_phones']?>" />
										</div>

										<div class="form-group">
											<label><?=LBL_Photo;?></label><br />
											<? if ($row['ggs_photo']) echo '<img src="media/ggs_staff/'.$row['ggs_photo'].'" width="150"/>'; ?>
											<input id="ggs_uphoto" name="ggs_uphoto" type="file" class="file">
										</div>


										<div class="form-group">
											<label><input type="checkbox" name="ggs_active" <? if (!$row || $row['ggs_active'] == 1) echo 'checked="checked"';?> /> <?=LBL_Active;?></label>
										</div>
										...
										<input type="hidden" name="ggs_dateadded" id="ggs_dateadded" value="<?=$row['ggs_dateadded'];?>" />
									</form>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!--/.col (left) -->
