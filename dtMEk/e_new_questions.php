									...
									<form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<textarea name="question_ar" required class="form-control"><? echo $_POST['question_ar'] ?: $row['question_ar']?></textarea>
											</div>
											<div class="form-group col-sm-4">
												<label><?=LBL_TitleEn;?></label>
												<textarea name="question_en" required class="form-control"><? echo $_POST['question_en'] ?: $row['question_en']?></textarea>
											</div>
											<div class="form-group col-sm-4">
												<label><?=LBL_TitleUr;?></label>
												<textarea name="question_ur" required class="form-control"><? echo $_POST['question_ur'] ?: $row['question_ur']?></textarea>
											</div>
											...
											<div class="form-group col-sm-4">
											    ...
											    ?>
											        <option <?php if ( (isset($_POST['competition_id']) && $_POST['competition_id']==  $competition['id'] ) || $row['competition_id'] == $competition['id'] ){echo "selected";}?> value="<?php echo $competition['id'];?>"><?php echo $competition['name_'.$_COOKIE['lang']]?></option>
											    <?php }?>
											    </select>
