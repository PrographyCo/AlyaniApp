                        ...
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="bus_title" required="required"
                                       value="<?php echo $_POST['bus_title'] ?: $row['bus_title'] ?>"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="bus_seats"
                                       value="<?php echo $_POST['bus_seats'] ?: $row['bus_seats'] ?>"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="bus_order"
                                       value="<?php echo $_POST['bus_order'] ?: $row['bus_order'] ?>"/>
                            </div>

                            <div class="form-group">
                                <label><input type="checkbox"
                                              name="bus_active" <?php if (!$row || $row['bus_active'] == 1) echo 'checked="checked"'; ?> /> <?= LBL_Active; ?>
                                </label>
                            </div>
