									...
									<form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<input type="text" class="form-control" name="gcat_title_ar" required="required" value="<? echo $_POST['gcat_title_ar'] ?: $row['gcat_title_ar']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleEn;?></label>
												<input type="text" class="form-control" name="gcat_title_en" required="required" value="<? echo $_POST['gcat_title_en'] ?: $row['gcat_title_en']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleUr;?></label>
												<input type="text" class="form-control" name="gcat_title_ur" required="required" value="<? echo $_POST['gcat_title_ur'] ?: $row['gcat_title_ur']?>" />
											</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="gcat_order" value="<? echo $_POST['gcat_order'] ?: $row['gcat_order']?>" />
										</div>

										<div class="form-group">
											<label><input type="checkbox" name="gcat_active" <? if (!$row || $row['gcat_active'] == 1) echo 'checked="checked"';?> /> <?=LBL_Active;?></label>
										</div>
