...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <a href="export_pils.php?city_id=<?= $_GET['city_id']; ?>&gender=<?= $_GET['gender']; ?>&pilc_id=<?= $_GET['pilc_id']; ?>&code=<?= $_GET['code']; ?>&resno=<?= $_GET['resno']; ?>&accomo=<?= $_GET['accomo']; ?>"
               class="btn btn-success pull-<?= DIR_AFTER; ?>" style="margin-<?= DIR_AFTER; ?>: 10px"><i
                        class="fa fa-file-excel-o"></i> <?= BTN_ExportToExcel; ?></a>
            <a href="import_pils.php" class="btn btn-success pull-<?= DIR_AFTER; ?>"
               style="margin-<?= DIR_AFTER; ?>: 10px"><i class="fa fa-file-excel-o"></i> <?= BTN_ImportFromExcel; ?></a>
            <a href="?deleteall=1&city_id=<?= $_GET['city_id']; ?>&gender=<?= $_GET['gender']; ?>&pilc_id=<?= $_GET['pilc_id']; ?>&code=<?= $_GET['code']; ?>&resno=<?= $_GET['resno']; ?>&accomo=<?= $_GET['accomo']; ?>"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <select name="accomo" id="accomo" class="form-control select2">
                                        ...
                                        <option value="1" <?php if ($_GET['accomo'] == 1) echo 'selected="selected"'; ?>>
                                            <?= LBL_VALIDACCOM; ?>
                                        </option>
                                        <option value="2" <?php if ($_GET['accomo'] == 2) echo 'selected="selected"'; ?>>
                                            <?= LBL_NOACCOM; ?>
                                        </option>
                                    </select>
                                </div>
