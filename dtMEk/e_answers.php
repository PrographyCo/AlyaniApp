									...
									<form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<textarea name="choice_ar" required class="form-control"><? echo $_POST['choice_ar'] ?: $row['choice_ar']?></textarea>
											</div>
											<div class="form-group col-sm-4">
												<label><?=LBL_choice;?> EN</label>
												<textarea name="choice_en" required class="form-control"><? echo $_POST['choice_en'] ?: $row['choice_en']?></textarea>
											</div>
											<div class="form-group col-sm-4">
												<label><?=LBL_choice ;?> UR </label>
												<textarea name="choice_ur" required class="form-control"><? echo $_POST['choice_ur'] ?: $row['choice_ur']?></textarea>
											</div>
											...
											<div class="form-group col-sm-4">
											    ...
											    ?>
											        <option <?php if ( (isset($_POST['question_id']) && $_POST['question_id']==  $item['id'] ) || $row['question_id'] == $item['id'] ){echo "selected";}?> value="<?php echo $item['id'];?>"><?php echo $item['question_'.$_COOKIE['lang']]?></option>
											    <?php }?>
											    </select>
												...
												<input type="checkbox" name="answer" value="1"  <?php if ( (isset($_POST['answer']) && $_POST['answer'] ==  1 ) || ($row['correct'] == 1) ){echo "checked";}?> />
											</div>
										...
										<input type="submit" name="send" class="col-md-12 btn btn-success" value="<? echo $edit ? LBL_Update : LBL_Add; ?>" />
