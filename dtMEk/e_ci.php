                        ...
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="ci_type" id="ci_type" class="form-control select2">
                                    <option value="1" <?php if ($row['ci_type'] == 1) echo 'selected="selected"'; ?>><?= LBL_Phone; ?></option>
                                    <option value="2" <?php if ($row['ci_type'] == 2) echo 'selected="selected"'; ?>><?= LBL_Email; ?></option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ci_value" required="required"
                                       value="<?php echo $_POST['ci_value'] ? $_POST['ci_value'] : $row['ci_value'] ?>"/>
                            </div>

                            <div class="form-group">
                                <label><?= LBL_Order; ?></label>
                                <input type="text" class="form-control" name="ci_order"
                                       value="<?php echo $_POST['ci_order'] ? $_POST['ci_order'] : $row['ci_order'] ?>"/>
                            </div>
