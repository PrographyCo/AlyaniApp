...
<script type="text/javascript">
    ...
    function initialize() {
        ...
        <?php if ($row['loc_lat'] && $row['loc_lng']) { ?>
        var mapOptions = {
                    ...
                    <div class="box-body">
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input class="form-control" id="field_lat" name="field_lat" type="text"
                                           value="<?php echo $row['loc_lat'] ?: $_POST['field_lat']; ?>"
                                           placeholder="Latitude"/>
                                    <input class="form-control" id="field_lon" name="field_lon" type="text"
                                           value="<?php echo $row['loc_lng'] ?: $_POST['field_lon']; ?>"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" class="form-control" name="loc_title_ar" required="required"
                                           value="<?php echo $_POST['loc_title_ar'] ?: $row['loc_title_ar'] ?>"/>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php if ($row['loc_photo']) echo '<img src="media/ourlocations/' . $row['loc_photo'] . '" width="150"/>'; ?>
                            ...
                            <div class="form-group">
                                <label><input type="checkbox"
                                              name="loc_active" <?php if (!$row || $row['loc_active'] == 1) echo 'checked="checked"'; ?> /> <?= LBL_Active; ?>
                                </label>
                            </div>
