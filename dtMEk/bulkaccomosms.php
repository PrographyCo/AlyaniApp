          ...
          <div class="row">
            ...
            <div class="col-md-12">
						<? echo $msg; ?>
							<div class="box">
								<div class="box-body">
									<form method="post" enctype="multipart/form-data" onsubmit="sendbulkSMSAccomo(); return false;">
										...
										<div class="row">
											<div class="form-group col-xs-12">
												...
												<select name="city_id[]" id="city_id[]" class="form-control select2" multiple="multiple" onchange="countCitiesPils();">
													<?
										...
										<input type="submit" id="submitbutton" class="btn btn-primary col-xs-12" value="<?=LBL_SendSMSs;?>" />
...
<script>
	...
	function countCitiesPils() {
		...
		var data = {
		 ...
		 $.post('post/countCitiesPilsAccomo.php', data, function(response){
	...
	function sendbulkSMSAccomo() {
		...
		var data = {
		 ...
		 $.post('post/sendbulkSMSAccomo.php', data, function(response){
