                        ...
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <textarea name="faq_answer_ar"
                                              class="form-control"><?php echo $_POST['faq_answer_ar'] ?: $row['faq_answer_ar'] ?></textarea>
                                </div>

                                <div class="form-group col-sm-4">
                                    <label><?= LBL_AnswerEn; ?></label>
                                    <textarea name="faq_answer_en"
                                              class="form-control"><?php echo $_POST['faq_answer_en'] ?: $row['faq_answer_en'] ?></textarea>
                                </div>

                                <div class="form-group col-sm-4">
                                    <label><?= LBL_AnswerUr; ?></label>
                                    <textarea name="faq_answer_ur"
                                              class="form-control"><?php echo $_POST['faq_answer_ur'] ?: $row['faq_answer_ur'] ?></textarea>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="faq_order"
                                       value="<?php echo $_POST['faq_order'] ?: $row['faq_order'] ?>"/>
                            </div>

                            <div class="form-group">
                                <label><input type="checkbox"
                                              name="faq_active" <?php if (!$row || $row['faq_active'] == 1) echo 'checked="checked"'; ?> /> <?= LBL_Active; ?>
                                </label>
                            </div>
