<?php
		...
		:timestamp
            ...
            if ($sql->execute()) {
                ...
                if ($_POST['role'] == 8) {
                    ...
                    // Delete old services
                    $sqldel = $db->exec("DELETE FROM _users_perms WHERE user_id = $id");
                    ...
                    $sqlins->bindParam(':user_id', $id, PDO::PARAM_INT);
                ...
                $label = isset($_REQUEST['id']) ? LBL_Update : LBL_Added;
    ...
    if (is_numeric($id)) {
        ...
        $row = $db->query("SELECT * FROM _users WHERE user_id = " . $id)->fetch(PDO::FETCH_ASSOC);
                        ...
                        <form role="form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="role" id="role"
                                    ...
                                    <option value="8" <?php if ((isset($row) && $row['userlevel'] == 8) || (isset($_POST['role']) && $_POST['role'] == 8)) echo 'selected="selected"'; ?>><?= LBL_Moderator ?></option>
                                    <option value="9" <?php if ((isset($row) && $row['userlevel'] == 9) || (isset($_POST['role']) && $_POST['role'] == 9)) echo 'selected="selected"'; ?>><?= LBL_Administrator ?></option>
                                </select>
                            </div>

                            <span id="permdiv" <?php if (isset($row) && $row['userlevel'] == 9) echo 'style="display:none"'; ?>>
                            ...
                            <select name="perms[]" id="perms[]" class="form-control select2"
                                ...
                                <?php
                                    ...
                                    if (!empty($id)) {
                                        ...
                                        $sql3->bindValue("user_id", $id, PDO::PARAM_INT);
                                        $sql3->execute();
