<?php
    ...
    $table_id = 'ga_id';
    $newedit_page = CP_PATH.'/general/edit/ga';
    
    if (isset($_GET['parent_id']) && $_GET['parent_id'] > 0) $newedit_page .= '?parent_id=' . $_GET['parent_id'];
                ...
                <div class="box">
                    <div class="box-body">
                        <table class="datatable-table4 table table-bordered table-striped">
                            ...
                            <?php
                                $sqlmore = '';
                                if (isset($_GET['parent_id']) && is_numeric($_GET['parent_id']) && $_GET['parent_id'] > 0) $sqlmore = " AND ga.ga_gcat_id = " . $_GET['parent_id'];
	                        ...
	                        <a href="' . $newedit_page . '' . ((isset($_GET['parent_id']) && $_GET['parent_id']) ? '&' : '?') . 'id=' . $row[$table_id] . '" class="label label-info"><i class="fa fa-edit"></i> ' . LBL_Modify . '</a>
