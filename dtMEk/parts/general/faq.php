<?php
    ...
    $table = 'faqs';
    $table_id = 'faq_id';
    $newedit_page = CP_PATH.'/general/edit/faq';
                ...
                <div class="box">
                    <div class="box-body">
                        <table class="datatable-table4 table table-bordered table-striped">
                            ...
                            <tbody>
                            <?php
                                $sql = $db->query("SELECT * FROM $table ORDER BY faq_order");
                                while ($row = $sql->fetch()) {
                                    
                                    echo '<tr>';
                                    echo '<td>';
                                    echo $row['faq_title_ar'];
                                    echo '</td>';
                                    echo '<td>';
                                    echo $row['faq_title_en'];
                                    echo '</td>';
                                    echo '<td>';
                                    echo $row['faq_title_en'];
                                    echo '</td>';
                                    echo '<td>';
                                    if ($row['faq_active'] == 1) echo '<span class="label label-success">' . LBL_Active . '</span>';
