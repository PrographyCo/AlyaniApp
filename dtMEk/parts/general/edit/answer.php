                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <textarea name="choice_ar" required
                                              class="form-control"><?= $_POST['choice_ar'] ?? $row['choice_ar'] ?? '' ?></textarea>
                                </div>
                                <div class="form-group col-sm-4">
                                    <label><?= LBL_choice ?> EN</label>
                                    <textarea name="choice_en" required
                                              class="form-control"><?= $_POST['choice_en'] ?? $row['choice_en'] ?? '' ?></textarea>
                                </div>
                                <div class="form-group col-sm-4">
                                    <label><?= LBL_choice ?> UR </label>
                                    <textarea name="choice_ur" required
                                              class="form-control"><?= $_POST['choice_ur'] ?? $row['choice_ur'] ?? '' ?></textarea>
                                </div>
                                    ...
                                    <select class="form-control" name="question_id">
                                        <?php
                                            ...
                                            foreach ($questions as $item) {
                                                ?>
                                                <option <?php if ((isset($_POST['question_id']) && $_POST['question_id'] == $item['id']) || (isset($row['question_id']) && $row['question_id'] == $item['id'])) {
                                                    echo "selected";
                                                } ?> value="<?= $item['id'] ?>"><?= $item['question_' . $_COOKIE['lang']] ?></option>
                                            <?php } ?>
                                    </select>
                                ...
                                <div class="form-group col-sm-4" style="margin-top: 21px;">
                                    ...
                                    <input type="checkbox" name="answer"
                                           value="1" <?php if ((isset($_POST['answer']) && $_POST['answer'] == 1) || (isset($row) && $row['correct'] == 1)) {
                                        echo "checked";
                                    } ?> />
                                </div>
