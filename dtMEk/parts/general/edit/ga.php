<?php
	...
	:ga_active
            ...
            $sql->bindValue("ga_active", (isset($_POST['ga_active']) ? 1 : 0));
            ...
            if ($sql->execute()) {
                ...
                if ($_FILES['ga_ufile_ar']['tmp_name']) {
                    ...
                    if (copy($_FILES['ga_ufile_ar']['tmp_name'], ASSETS_PATH.'media/ga_articles/' . $id . '_ar.' . $ext)) {
                ...
                if ($_FILES['ga_ufile_en']['tmp_name']) {
                    ...
                    if (copy($_FILES['ga_ufile_en']['tmp_name'], ASSETS_PATH.'media/ga_articles/' . $id . '_en.' . $ext)) {
                ...
                if ($_FILES['ga_ufile_ur']['tmp_name']) {
                    ...
                    if (copy($_FILES['ga_ufile_ur']['tmp_name'], ASSETS_PATH.'media/ga_articles/' . $id . '_ur.' . $ext)) {
                        ...
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="ga_type" class="form-control"
                                    ...
                                    <option value="1" <?php if (isset($row) && $row['ga_type'] == 1) echo 'selected="selected"'; ?>><?= LBL_Text ?></option>
                                    <option value="2" <?php if (isset($row) && $row['ga_type'] == 2) echo 'selected="selected"'; ?>><?= LBL_PDFFILE ?></option>
                                </select>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" class="form-control" name="ga_title_ar" required="required"
                                           value="<?= $_POST['ga_title_ar'] ?? $row['ga_title_ar'] ?? '' ?>"/>
                                </div>

                                <div class="form-group col-sm-4">
                                    <label><?= LBL_TitleEn ?></label>
                                    <input type="text" class="form-control" name="ga_title_en" required="required"
                                           value="<?= $_POST['ga_title_en'] ?? $row['ga_title_en'] ?? '' ?>"/>
                                </div>

                                <div class="form-group col-sm-4">
                                    <label><?= LBL_TitleUr ?></label>
                                    <input type="text" class="form-control" name="ga_title_ur" required="required"
                                           value="<?= $_POST['ga_title_ur'] ?? $row['ga_title_ur'] ?? '' ?>"/>
                                </div>

                            </div>

                            <div id="div_text"
                                 style="<?php if (!isset($row) || $row['ga_type'] == 1 || (isset($_POST['ga_type']) && $_POST['ga_type'] == 1)) echo 'display:block'; else echo 'display:none'; ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <textarea name="ga_body_ar"
                                                  class="form-control"><?= $_POST['ga_body_ar'] ?? $row['ga_body_ar'] ?? '' ?></textarea>
                                    </div>

                                    <div class="form-group col-sm-4">
                                        <label><?= LBL_DescrEn ?></label>
                                        <textarea name="ga_body_en"
                                                  class="form-control"><?= $_POST['ga_body_en'] ?? $row['ga_body_en'] ?? '' ?></textarea>
                                    </div>

                                    <div class="form-group col-sm-4">
                                        <label><?= LBL_DescrUr ?></label>
                                        <textarea name="ga_body_ur"
                                                  class="form-control"><?= $_POST['ga_body_ur'] ?? $row['ga_body_ur'] ?? '' ?></textarea>
                                    </div>
                            ...
                            <div id="div_file"
                                 style="<?php if ((isset($row) && $row['ga_type'] == 2) || (isset($_POST['ga_type']) && $_POST['ga_type'] == 2)) echo 'display:block'; else echo 'display:none'; ?>">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <?php
                                            if ($row['ga_file_ar']) {
                                                ...
                                                echo '<a href="'.CP_PATH.'/assets/media/ga_articles/' . $row['ga_file_ar'] . '" target="_blank">' . LBL_ViewFile . '</a>';
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <?php
                                            if ($row['ga_file_en']) {
                                                ...
                                                echo '<a href="'.CP_PATH.'/assets/media/ga_articles/' . $row['ga_file_en'] . '" target="_blank">' . LBL_ViewFile . '</a>';
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <?php
                                            if ($row['ga_file_ur']) {
                                                ...
                                                echo '<a href="'.CP_PATH.'/assets/media/ga_articles/' . $row['ga_file_ur'] . '" target="_blank">' . LBL_ViewFile . '</a>';
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ga_order"
                                       value="<?= $_POST['ga_order'] ?? $row['ga_order'] ?? '' ?>"/>
                            </div>

                            <div class="form-group">
                                <label><input type="checkbox"
                                              name="ga_active" <?php if (!isset($row) || $row['ga_active'] == 1) echo 'checked="checked"'; ?> /> <?= LBL_Active ?>
                                </label>
                            </div>
