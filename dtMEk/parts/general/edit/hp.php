<?php
	...
	:hp_lastupdated
            ...
            $sql->bindValue("hp_active", (isset($_POST['hp_active']) ? 1 : 0));
                    ...
                    <div class="box-body">
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <?php if (isset($row['hp_photo']) && $row['hp_photo']) echo '<img src="'.CP_PATH.'/assets/media/hajalbum/' . $row['hp_photo'] . '" width="150"/>'; ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="hp_order"
                                       value="<?= $_POST['hp_order'] ?? $row['hp_order'] ?? '' ?>"/>
                            </div>

                            <div class="form-group">
                                <label><input type="checkbox"
                                              name="hp_active" <?php if (!isset($row) || $row['hp_active'] == 1) echo 'checked="checked"'; ?> /> <?= LBL_Active ?>
                                </label>
                            </div>
