...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <a href="<?= CP_PATH ?>/accomo/export/export_accomo_buildings?building_id=<?= $_GET['building_id']??'' ?>&floor_id=<?= $_GET['floor_id']??'' ?>"
            ...
            <a href="?remove=1&building_id=<?= $_GET['building_id']??'' ?>&floor_id=<?= $_GET['floor_id']??'' ?>"
            ...
            <div class="col-md-12">
                            ...
                            <div class="row">
                                    ...
                                    <select name="building_id" id="building_id" class="form-control select2">
                                        ...
                                        <?php
                                            ...
                                            while ($rowb = $sqlblds->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                if (isset($_GET['building_id']) && $_GET['building_id'] == $rowb['bld_id']) echo 'selected="selected"';
                                                echo '>
															' . $rowb['bld_title'] . '
															</option>';
                                            }
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <select name="floor_id" id="floor_id" class="form-control select2">
                                        ...
                                        <?php
                                            if (isset($_GET['building_id']) && is_numeric($_GET['building_id']) && $_GET['building_id'] > 0) {
                                                ...
                                                while ($rowf = $sqlfloors->fetch(PDO::FETCH_ASSOC)) {
                                                    ...
                                                    if (isset($_GET['floor_id']) && $_GET['floor_id'] == $rowf['floor_id']) echo 'selected="selected"';
                                                    echo '>
															' . $rowf['floor_title'] . '
															</option>';
                                                }
                ...
                <div class="box">
                    ...
                    <?php if (isset($_GET['building_id'])) {
                        ...
                        $stmt->execute(array($_GET['floor_id']??0));
                        $floor = $stmt->fetch();
                        
                        ?>
                        <div style="padding: 26px;font-size: 18px;">
                            <p><?= (($building)?$building['bld_title']:'Not selected') . " - " . (($floor)?$floor['floor_title']:'Not selected') ?></p>
