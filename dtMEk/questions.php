                        ...
                        <table class="datatable-table4 table table-bordered table-striped">
                            ...
                            <?
                                ...
                                while ($row = $sql->fetch()) {
                                    ...
                                    echo '<a href="' . basename($_SERVER['PHP_SELF']) . '?del=' . $row[$table_id] . '" class="label label-danger" onclick="return confirm(\'' . LBL_DeleteConfirm . '\');"><i class="fa fa-trash"></i> ' . LBL_Delete . '</a>';
