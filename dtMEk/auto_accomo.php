...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <?=$title;?>
            <a href="?removeall=1" onclick="return confirm('<?=LBL_RemoveAccomoConfirm;?>');" class="btn btn-danger pull-<?=DIR_AFTER;?>" style="margin-<?=DIR_AFTER;?>: 10px"><i class="fa fa-trash"></i> <?=BTN_REMOVEACCOMO;?></a>
          </h1>
        </section>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
						<? echo $msg; ?>
							<div class="box">
								<div class="box-body">
									<form method="post" action="auto_accomo.php" enctype="multipart/form-data">


										<div class="panel well">
											<?=LBL_NotAccomoPilgrims;?>: <span id="countpils">0</span> - <?=LBL_AvailableForAccomo;?>: <span id="availcount">0</span>
										</div>

										<div class="row">
											<div class="form-group col-sm-4">
												<label><?=LBL_Cities;?></label>
												<select name="city_id[]" id="city_id[]" class="form-control select2" multiple="multiple" onchange="countCitiesPils(); calcAvailAccomo();">
													<?
											...
											<div class="form-group col-sm-4">
												...
												<select name="gender" id="gender" class="form-control select2" onchange="countCitiesPils(); calcAvailAccomo(); getAccomosGender(this.value);">
													<option value="0">
														<?=LBL_All;?>
													</option>
											...
											<div class="form-group col-sm-4">
												...
												<select name="pilc_id" id="pilc_id" class="form-control select2" onchange="countCitiesPils();">
													<option value="0">
														<?=LBL_All;?>
													</option>
													<?
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<div id="SuitesArea">
													...
													<select name="suite_id[]" id="suite_id[]" class="form-control select2" multiple="multiple" onchange="suites_selected(); calcAvailAccomo();">
														<?
											...
											<div class="form-group col-sm-4">
												...
												<div id="BuildingsTypeArea">
													<select name="bld_type" id="bld_type" class="form-control select2" onchange="bldtype_selected(this.value); calcAvailAccomo();">
														<option value="0">
															<?=LBL_All;?>
														</option>
														<option value="1">
											...
											<div class="form-group col-sm-4">
												...
												<div id="TentsArea">
													<select name="tent_id[]" id="tent_id[]" class="form-control select2" multiple="multiple" onchange="calcAvailAccomo();">
														<?
											...
											foreach ($_POST['city_id'] as $city_id) {
												...
												if ($sql1->rowCount() > 0) {
													...
													while ($row1 = $sql1->fetch(PDO::FETCH_ASSOC)) {
														...
														if (!$accomodated && is_array($_POST['suite_id']) && sizeof($_POST['suite_id']) > 0) {

															// accomodate to suites
															$accomodated = AccomoSuites($_POST['suite_id'], $_POST['hall_id'], $_POST['extratype_id'], $row1['pil_code'], $row1['pil_gender']);
															if ($accomodated) {
														...
														if (!$accomodated && is_array($_POST['building_id']) && sizeof($_POST['building_id']) > 0) {
														...
														if (!$accomodated && is_array($_POST['tent_id']) && sizeof($_POST['tent_id']) > 0) {
