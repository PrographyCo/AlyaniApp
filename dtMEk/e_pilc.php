									...
									<form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<input type="text" class="form-control" name="pilc_title_ar" required="required" value="<? echo $_POST['pilc_title_ar'] ?: $row['pilc_title_ar']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleEn;?></label>
												<input type="text" class="form-control" name="pilc_title_en" required="required" value="<? echo $_POST['pilc_title_en'] ?: $row['pilc_title_en']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_TitleUr;?></label>
												<input type="text" class="form-control" name="pilc_title_ur" required="required" value="<? echo $_POST['pilc_title_ur'] ?: $row['pilc_title_ur']?>" />
											</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="pilc_order" value="<? echo $_POST['pilc_order'] ?: $row['pilc_order']?>" />
										</div>
										...
										<div class="row">
											<div class="form-group col-sm-6">
												...
												<select name="pilc_text_id" id="pilc_text_id" class="form-control select2">
													<option value="1" <? if ($row['pilc_text_id'] == 1) echo 'selected="selected"';?>><?=LBL_Mokhayam;?></option>
													<option value="2" <? if ($row['pilc_text_id'] == 2) echo 'selected="selected"';?>><?=LBL_Omara;?></option>
												</select>
											</div>

											<div class="form-group col-sm-6">
												<label><?=LBL_Number;?></label>
												<input type="text" class="form-control" name="pilc_text_text" required="required" value="<? echo $_POST['pilc_text_text'] ?: $row['pilc_text_text']?>" />
											</div>
										</div>

										<div class="form-group">
											<label><?=LBL_ContactNumbers;?></label>
											<input type="text" class="form-control" name="pilc_phones" value="<? echo $_POST['pilc_phones'] ?: $row['pilc_phones']?>" />
										</div>
										...
										<div class="form-group">
											<label><input type="checkbox" name="pilc_active" <? if (!$row || $row['pilc_active'] == 1) echo 'checked="checked"';?> /> <?=LBL_Active;?></label>
										</div>

										<input type="submit" class="col-md-12 btn btn-success" value="<? echo $edit ? LBL_Update : LBL_Add; ?>" />
										<input type="hidden" name="id" id="id" value="<?=$_GET['id'];?>" />
										<input type="hidden" name="pilc_dateadded" id="pilc_dateadded" value="<?=$row['pilc_dateadded'];?>" />
									</form>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!--/.col (left) -->
