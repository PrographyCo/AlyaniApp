                        ...
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="room_title" required="required"
                                       value="<?php echo $_POST['room_title'] ?: $row['room_title'] ?>"/>
                            </div>

                            <div class="form-group">
                                <label><?= LBL_Gender; ?></label>
                                <select name="room_gender" class="form-control select2">
                                    <option value="m" <?php if ($row['room_gender'] == 'm') echo 'selected="selected"'; ?>><?= LBL_Male; ?></option>
                                    <option value="f" <?php if ($row['room_gender'] == 'f') echo 'selected="selected"'; ?>><?= LBL_Female; ?></option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="room_capacity"
                                       value="<?php echo $_POST['room_capacity'] ?: $row['room_capacity'] ?>"/>
                            </div>

                            <div class="form-group">
                                <label><?= LBL_Order; ?></label>
                                <input type="text" class="form-control" name="room_order"
                                       value="<?php echo $_POST['room_order'] ?: $row['room_order'] ?>"/>
                            </div>

                            <div class="form-group">
                                <label><input type="checkbox"
                                              name="room_active" <?php if (!$row || $row['room_active'] == 1) echo 'checked="checked"'; ?> /> <?= LBL_Active; ?>
                                </label>
                            </div>
