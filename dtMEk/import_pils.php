            ...
            <div class="col-md-12">
                                ...
                                <select name="pilc_id" id="pilc_id" class="form-control select2" required="required">
                                    ...
                                    <?
                                        ...
                                        while ($rowc = $sqlc->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            if ($_POST['pilc_id'] == $rowc['pilc_id']) echo 'selected="selected"';
                ...
                <?
                    ...
                    if ($_POST['confirm']) {
                        ...
                        if (is_file("media/imports/" . $_POST['fileimportned'])) {
                            
                            $inputFileName = "media/imports/" . $_POST['fileimportned'];
                            $objPHPExcel = PHPExcel_IOFactory::load($inputFileName);
                            $sheetData = $objPHPExcel->getActiveSheet()->toArray(null, true, true, true);
                            //var_dump($sheetData);
                            //
