...
if ($_POST) {
	...
	$sql->bindValue("q_active", ($_POST['q_active'] ? 1 : 0));
	...
	if ($sql->execute()) {
		...
		// add / modify answers
		if (is_array($_POST['answer_ar']) && sizeof($_POST['answer_ar'] > 0)) {
									...
									<form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="form-group col-sm-4">
												...
												<input type="text" class="form-control" name="q_title_ar" required="required" value="<? echo $_POST['q_title_ar'] ?: $row['q_title_ar']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_QuestionEn;?></label>
												<input type="text" class="form-control" name="q_title_en" required="required" value="<? echo $_POST['q_title_en'] ?: $row['q_title_en']?>" />
											</div>

											<div class="form-group col-sm-4">
												<label><?=LBL_QuestionUr;?></label>
												<input type="text" class="form-control" name="q_title_ur" required="required" value="<? echo $_POST['q_title_ur'] ?: $row['q_title_ur']?>" />
											</div>
										...
										<div class="form-group">
											<label><?=LBL_Order;?></label>
											<input type="text" class="form-control" name="q_order" value="<? echo $_POST['q_order'] ?: $row['q_order']?>" />
										</div>

										<div class="form-group">
											<label><input type="checkbox" name="q_active" <? if (!$row || $row['q_active'] == 1) echo 'checked="checked"'; ?>/> Active</label>
										</div>
